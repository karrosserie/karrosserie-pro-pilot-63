-- Mettre à jour la contrainte pour accepter le type 'vehicle'
...
CHECK (
  ...
  (entity_type = 'messagerie' AND messagerie_id IS NOT NULL AND employee_id IS NULL AND vehicle_id IS NULL AND repair_order_id IS NULL)
);