-- Modifier le trigger handle_new_user pour éviter la création automatique d'entreprise
-- quand l'utilisateur est ajouté via l'interface équipe

-- Supprimer l'ancien trigger et fonction
drop trigger if exists on_auth_user_created on auth.users;
drop function if exists public.handle_new_user();

-- Créer la nouvelle fonction handle_new_user améliorée
