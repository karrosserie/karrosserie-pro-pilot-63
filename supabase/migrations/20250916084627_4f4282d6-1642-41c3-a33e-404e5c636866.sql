-- Fix RLS policies for tracking tables - force drop and recreate

-- Drop all existing policies for tracking tables
...
DROP POLICY IF EXISTS "Users can manage their own errors and abandons" ON public.user_errors_abandons;
