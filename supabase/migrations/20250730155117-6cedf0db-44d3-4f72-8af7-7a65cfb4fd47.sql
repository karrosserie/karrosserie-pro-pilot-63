-- Corriger la fonction pour utiliser l'extension http existante
    ...
    IF NEW.client_id IS NOT NULL AND NEW.vehicle_id IS NOT NULL THEN
        ...
        IF NEW.company_id IS NOT NULL THEN
            ...
            IF client_email IS NOT NULL AND client_email != '' THEN
                ...
                RAISE LOG 'Auto-created quote from expertise report and sent document request email to: % (HTTP status: %)', target_email, http_result.status;
            ELSE
