...
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS start_date DATE;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS end_date DATE;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'En attente';
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS road_test TEXT;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS road_test_notes TEXT;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS fuel_level INTEGER DEFAULT 50;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS pre_accident_defects TEXT;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS work_items JSONB;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS registration_document_front_url TEXT;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS registration_document_back_url TEXT;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS vehicle_image_url TEXT;
ALTER TABLE public.vehicles ADD COLUMN IF NOT EXISTS vehicle_images JSONB;
...
-- Insert default car models for each brand
