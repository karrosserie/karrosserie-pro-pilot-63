-- Modifier la fonction trigger pour transférer les remises globales vers discounts_data
...
BEGIN
    ...
    IF NEW.client_id IS NOT NULL AND NEW.vehicle_id IS NOT NULL THEN
        ...
        IF NEW.company_id IS NOT NULL THEN
            ...
            RAISE LOG 'Auto-created quote from expertise report: %, quote reference: %, global_discount_data: %', 
                NEW.id, new_reference, NEW.global_discount_data;
        END IF;
    END IF;
