-- Corriger le matching des qualifications avec les types de tâches réels
...
BEGIN
  ...
  SELECT 
    ...
    CASE 
      ...
      WHEN uc.role = 'carrossier' THEN 95  -- Ajout du rôle carrossier
      WHEN uc.role = 'carrossier-vehicule de courtoisie' THEN 85  -- Ajout du rôle carrossier véhicule de courtoisie
