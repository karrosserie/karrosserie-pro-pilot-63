...
CREATE INDEX idx_fleet_returns_reservation_id ON fleet_returns(fleet_reservation_id);
CREATE INDEX idx_fleet_returns_vehicle_id ON fleet_returns(fleet_vehicle_id);
CREATE INDEX idx_fleet_returns_client_id ON fleet_returns(client_id);
CREATE INDEX idx_fleet_returns_user_id ON fleet_returns(user_id);
CREATE INDEX idx_fleet_returns_return_date ON fleet_returns(return_date);
CREATE INDEX idx_fleet_returns_status ON fleet_returns(status);
