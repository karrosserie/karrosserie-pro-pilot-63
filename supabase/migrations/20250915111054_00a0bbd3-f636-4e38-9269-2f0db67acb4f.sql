-- Migration des photos de tâches depuis employee_schedule vers task_photos
...
-- Étape 3: Supprimer les colonnes photo de employee_schedule (après migration)
-- Cette étape sera faite plus tard après vérification que tout fonctionne

-- Étape 4: Supprimer le bucket employee-tasks (via SQL)
