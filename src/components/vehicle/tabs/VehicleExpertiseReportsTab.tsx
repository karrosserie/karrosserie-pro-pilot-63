                ...
                sortedData.map((report) => (
                  <React.Fragment key={report.id}>
                    <TableRow className="border-b-0">
                      <TableCell className="font-medium text-xs sm:text-sm py-2 sm:py-4">{report.report_number || 'Non spécifié'}</TableCell>
                      <TableCell className="text-xs sm:text-sm py-2 sm:py-4">{report.report_date ? new Date(report.report_date).toLocaleDateString('fr-FR') : 'Non spécifiée'}</TableCell>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              ...
                              >
                                ...
                                <span className="hidden sm:inline sm:ml-1">Télécharger</span>
                              </Button>
                            </TooltipTrigger>
