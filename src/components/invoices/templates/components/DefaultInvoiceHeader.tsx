    ...
    <div className="grid grid-cols-3 gap-6 mb-6">
      ...
      <div>
        ...
        {companyData.logo_url ? (
          <div className="flex items-start justify-start mb-3" style={{maxWidth: '400px'}}>
            <img src={companyData.logo_url} alt="Logo entreprise" className="max-w-full h-auto object-contain" style={{maxHeight: '240px'}} />
          </div>
        ) : (
