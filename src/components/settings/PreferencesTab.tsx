                 ...
                 <div className="bg-white p-4 rounded shadow-sm h-full flex flex-col">
                      ...
                      <table className="w-full text-base bg-white border-2 border-black rounded-lg overflow-hidden">
                        <thead>
                          <tr style={{ backgroundColor: 'rgba(64,67,72,255)' }} className="text-white">
                            <th className="p-3 text-left font-medium border-r border-black">Article</th>
                            <th className="p-3 text-right font-medium border-r border-black">Quantité</th>
                            <th className="p-3 text-right font-medium border-r border-black">Coût Unitaire</th>
                            <th className="p-3 text-right font-medium border-r border-black">Remise</th>
                            <th className="p-3 text-right font-medium border-r border-black">TVA</th>
                            <th className="p-3 text-right font-medium">Total HT</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="border-b border-black">
                            <td className="p-3 border-r border-black">Réparation pare-chocs avant</td>
                            <td className="p-3 text-right border-r border-black">1</td>
                            <td className="p-3 text-right border-r border-black">350,00 €</td>
                            <td className="p-3 text-right border-r border-black">0%</td>
                            <td className="p-3 text-right border-r border-black">20%</td>
                            <td className="p-3 text-right font-medium">350,00 €</td>
                          </tr>
                          <tr className="border-b border-black">
                            <td className="p-3 border-r border-black">Peinture carrosserie</td>
                            <td className="p-3 text-right border-r border-black">1</td>
                            <td className="p-3 text-right border-r border-black">450,00 €</td>
                            <td className="p-3 text-right border-r border-black">0%</td>
                            <td className="p-3 text-right border-r border-black">20%</td>
                            <td className="p-3 text-right font-medium">450,00 €</td>
                          </tr>
                          <tr className="border-b border-black">
                            <td className="p-3 border-r border-black">Pièce détachée - Feu avant gauche</td>
                            <td className="p-3 text-right border-r border-black">1</td>
                            <td className="p-3 text-right border-r border-black">125,00 €</td>
                            <td className="p-3 text-right border-r border-black">5%</td>
                            <td className="p-3 text-right border-r border-black">20%</td>
                      ...
                      <table className="w-full text-sm border-collapse">
                        <thead>
                          <tr>
                            ...
                            <th className="border-2 border-black p-2 text-center">Total TTC</th>
                          </tr>
                        </thead>
                     <tbody>
                       <tr>
                         ...
                         <td className="border-2 border-black p-2 text-center">264,00€</td>
                       </tr>
                       <tr>
                         <td className="border-2 border-black p-2"></td>
                       ...
                       <tr>
                         ...
                         <td className="border-2 border-black p-2 text-center">108,30€</td>
                       </tr>
                       <tr>
                         <td className="border-2 border-black p-2"></td>
                  ...
                  <div className="flex justify-end">
                    <table className="border-2 border-black text-sm rounded-lg overflow-hidden">
                      <tbody>
                        <tr>
                          <td className="border border-black p-2 font-bold text-center">TOTAL HT</td>
                          <td className="border border-black p-2 font-bold text-center">TOTAL TVA</td>
                          <td className="border border-black p-2 font-bold text-center">Total Remise</td>
                          <td className="border border-black p-2 font-bold text-center">Total TTC</td>
                        </tr>
                        <tr>
                          <td className="border border-black p-2 text-center">530,25€</td>
                          <td className="border border-black p-2 text-center">106,05€</td>
                          <td className="border border-black p-2 text-center">5,30€</td>
                          <td className="border border-black p-2 text-center">630,00€</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
