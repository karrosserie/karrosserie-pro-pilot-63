...
import { QuoteRepairItem } from './types';

interface QuoteRepairsSectionProps {
  repairs: QuoteRepairItem[];
  onRepairsChange: (repairs: QuoteRepairItem[]) => void;
  isReadOnly?: boolean;
}

export const QuoteRepairsSection = ({ repairs, onRepairsChange, isReadOnly = false }: QuoteRepairsSectionProps) => {
  const addRepair = () => {
