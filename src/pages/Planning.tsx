          ...
          <TabsContent value="employees" className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-2xl font-bold">Planning par Employé</h2>
                <Badge variant="outline" className="ml-2">Tri chronologique automatique</Badge>
              </div>
              <p className="text-muted-foreground">Vue détaillée des tâches de chaque employé triées par heure (uniquement pour le manager)</p>
            </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-lg text-blue-600">Martin Dubois</CardTitle>
                    <p className="text-sm text-muted-foreground">martin.dubois@carrosserie.fr</p>
              ...
              <CardContent className="space-y-4">
                {/* Planning de Martin Dubois */}
                <div className="flex items-center gap-2 mb-4">
                  <User className="w-4 h-4 text-muted-foreground" />
                  <h3 className="font-semibold">Planning de Martin Dubois</h3>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="font-medium text-orange-600">Tâches en cours</h4>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline">Tri chronologique</Badge>
                  ...
                  <Card className="border-l-4 border-l-red-500 p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-red-600">18h-12h</span>
                        <Badge variant="destructive" className="text-xs">URGENT</Badge>
                      </div>
                      <Button size="sm" variant="destructive">Terminer</Button>
                    </div>
                    <div className="space-y-2">
                      <div className="font-medium">Finitions & remontage</div>
                      <Badge className="bg-blue-100 text-blue-800 text-xs">En cours</Badge>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="text-muted-foreground">Véhicule:</span>
                          <div className="font-medium text-blue-600">AB-789-XY</div>
                        </div>
                        <div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-muted-foreground">Durée estimée: 2h</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="border-l-4 border-l-yellow-500 p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-yellow-600">14h-15h30</span>
                      </div>
                      <Button size="sm" variant="outline">Terminer</Button>
                    </div>
                    <div className="space-y-2">
                      <div className="font-medium">Polissage final</div>
                      <Badge className="bg-blue-100 text-blue-800 text-xs">En cours</Badge>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="text-muted-foreground">Véhicule:</span>
                          <div className="font-medium text-blue-600">EF-456-UV</div>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Modèle:</span>
                        ...
                        <div className="flex items-center gap-1">
                          <Calendar className="w-3 h-3" />
                          <span className="text-muted-foreground">Durée estimée: 1h</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="border-l-4 border-l-yellow-500 p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <Clock className="w-4 h-4 text-yellow-600" />
                        <span className="font-medium text-yellow-600">14h-14h30</span>
                      </div>
                      <Button size="sm" variant="outline">Terminer</Button>
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="text-muted-foreground">Véhicule:</span>
                          <div className="font-medium text-blue-600">EZ-787-KL</div>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Modèle:</span>
                          <div>Citroën C4</div>
                        ...
                        <div className="flex items-center gap-1">
                          <Calendar className="w-3 h-3" />
                          <span className="text-muted-foreground">Durée estimée: 0h</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                ...
                <div className="space-y-3 mt-6">
                  <div className="flex items-center justify-between">
                    <h4 className="font-medium text-green-600">Tâches terminées aujourd'hui</h4>
                    <div className="flex items-center gap-2">
                      <Badge variant="outline">Tri chronologique</Badge>
                  ...
                  <div className="space-y-2">
                    <Card className="border-l-4 border-l-green-500 p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-green-600">8h-9h</span>
                          <span className="text-sm">Expertise assurance</span>
                          <Badge className="bg-green-100 text-green-800 text-xs">Terminé</Badge>
                        </div>
                        <Button size="sm" variant="ghost">Voir détails</Button>
                      </div>
                      <div className="text-xs text-muted-foreground mt-1">QR-345-ST - Mercedes Classe C - Mme Leclerc</div>
                    </Card>
                    ...
                    <Card className="border-l-4 border-l-green-500 p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Clock className="w-3 h-3 text-green-600" />
                          <span className="text-sm font-medium text-green-600">9h-10h</span>
                          <span className="text-sm">Accueil & Préparation</span>
                          <Badge className="bg-green-100 text-green-800 text-xs">Terminé</Badge>
                        </div>
                        <Button size="sm" variant="ghost">Voir détails</Button>
                      </div>
                      <div className="text-xs text-muted-foreground mt-1">EZ-787-KL - Citroën C4 - M. Durand</div>
                    </Card>
                    ...
                    <Card className="border-l-4 border-l-green-500 p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Clock className="w-3 h-3 text-green-600" />
                          <span className="text-sm font-medium text-green-600">11h-11h30</span>
                          <span className="text-sm">Contrôle qualité</span>
                          <Badge className="bg-green-100 text-green-800 text-xs">Terminé</Badge>
                        </div>
                        <Button size="sm" variant="ghost">Voir détails</Button>
                      </div>
                      <div className="text-xs text-muted-foreground mt-1">GH-789-ST - Ford Focus - M. Roux</div>
                    </Card>
                    ...
                    <Card className="border-l-4 border-l-green-500 p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Clock className="w-3 h-3 text-green-600" />
                          <span className="text-sm font-medium text-green-600">14h-16h</span>
                          <span className="text-sm">Débosselage léger</span>
                          <Badge className="bg-green-100 text-green-800 text-xs">Terminé</Badge>
                        </div>
                        <Button size="sm" variant="ghost">Voir détails</Button>
                      </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-lg text-blue-600">Sophie Martin</CardTitle>
                    <p className="text-sm text-muted-foreground">sophie.martin@carrosserie.fr</p>
                    <div className="flex gap-2 mt-2">
                      <Badge className="bg-yellow-100 text-yellow-800 text-xs">Préparation peinture</Badge>
                      <Badge className="bg-orange-100 text-orange-800 text-xs">Mise en peinture</Badge>
                      <Badge className="bg-purple-100 text-purple-800 text-xs">Finitions & remontage</Badge>
              ...
              <CardContent className="space-y-4">
                {/* Planning de Sophie Martin */}
                <div className="flex items-center gap-2 mb-4">
                  <User className="w-4 h-4 text-muted-foreground" />
                  <h3 className="font-semibold">Planning de Sophie Martin</h3>
                </div>
                <div className="flex gap-4 text-center mb-6">
                  <div>
                ...
                <div className="space-y-3">
                  ...
                  <Card className="border-l-4 border-l-yellow-500 p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <Clock className="w-4 h-4 text-yellow-600" />
                        <span className="font-medium text-yellow-600">8h-11h</span>
                      </div>
                      <Button size="sm" variant="outline">Terminer</Button>
                    </div>
                    <div className="space-y-2">
                      <div className="font-medium">Remplacement pare-chocs</div>
                      <Badge className="bg-blue-100 text-blue-800 text-xs">En cours</Badge>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="text-muted-foreground">Véhicule:</span>
                          <div className="font-medium text-blue-600">HT-556-GH</div>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Modèle:</span>
                          <div>BMW Série 1</div>
                        ...
                        <div className="flex items-center gap-1">
                          <Calendar className="w-3 h-3" />
                          <span className="text-muted-foreground">Durée estimée: 3h</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="border-l-4 border-l-orange-500 p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-orange-600">9h-13h</span>
                      </div>
                      <Button size="sm" variant="outline">Terminer</Button>
                    </div>
                    <div className="space-y-2">
                      <div className="font-medium">Application base peinture</div>
                      <Badge variant="outline" className="text-xs">Planifié</Badge>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="text-muted-foreground">Véhicule:</span>
                          <div className="font-medium text-blue-600">CD-123-ZW</div>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Modèle:</span>
                        ...
                        <div className="flex items-center gap-1">
                          <Calendar className="w-3 h-3" />
                          <span className="text-muted-foreground">Durée estimée: 4h</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <div className="space-y-2">
                    <Card className="border-l-4 border-l-green-500 p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Clock className="w-3 h-3 text-green-600" />
                          <span className="text-sm font-medium text-green-600">8h-10h</span>
                          <span className="text-sm">Préparation peinture</span>
                          <Badge className="bg-green-100 text-green-800 text-xs">Terminé</Badge>
                        </div>
                        <Button size="sm" variant="ghost">Voir détails</Button>
                      </div>
                      <div className="text-xs text-muted-foreground mt-1">HT-556-GH - BMW Série 1 - M. Rousseau</div>
                    </Card>
                    ...
                    <Card className="border-l-4 border-l-green-500 p-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Clock className="w-3 h-3 text-green-600" />
                          <span className="text-sm font-medium text-green-600">10h-12h</span>
                          <span className="text-sm">Débosselage portière</span>
                          <Badge className="bg-green-100 text-green-800 text-xs">Terminé</Badge>
                        </div>
                        <Button size="sm" variant="ghost">Voir détails</Button>
                      </div>
                      <div className="text-xs text-muted-foreground mt-1">VS-901-AB - Audi A4 - M. Bernard</div>
                    </Card>
                  </div>
                </div>
              </CardContent>
